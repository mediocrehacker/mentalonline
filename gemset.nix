{
  ...
  attr_json = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0h8b4s8bcjvcy2xlpf32f9x3b7bm6zgiyccr24l46czx5283vb3h";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  mobility = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0k5z8ajgibh7szfw2bnzdcsg70hqkpnl14fqh8pd1qjl0qg8zf70";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  nokogiri = {
    ...
    targets = [{
      remotes = ["https://rubygems.org"];
      sha256 = "02lxnn3n5fimnc8kf5ryhkfxl8yg66h5z2v2xa89fw45c0j8zh0h";
      target = "arm64-darwin";
      targetCPU = "arm64";
      targetOS = "darwin";
      type = "gem";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "08bcmj50mwrjpb8mrgffi74chrfnfnrznkpbwgp7f1y4al8qd3f6";
      target = "arm-linux";
      targetCPU = "arm";
      targetOS = "linux";
      type = "gem";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "0hzslkyh304x740v3cmgkkdlpg3fj9vpc5lpy4af1f7nksdshyi3";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "0lvz4hckprr7scww0hfqb7072as27g7qbf7brqczb95yskgq3ncc";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "1js1a3ywl9zpqgm9p8ki6y50k95xm46xfy2vxqigrw9mibd0g48m";
      target = "x86-linux";
      targetCPU = "x86";
      targetOS = "linux";
      type = "gem";
  ...
  spina = {
    dependencies = ["ancestry" "attr_json" "babosa" "bcrypt" "breadcrumbs_on_rails" "browser" "image_processing" "importmap-rails" "jsonapi-serializer" "kaminari" "mobility" "pg" "rack-rewrite" "rails" "sprockets-rails" "stimulus-rails" "tailwindcss-rails" "turbo-rails" "view_component"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0438r01kswsj6ax0nzbicbh55p62q645kp65p148fl7kvy763bz2";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  tailwindcss-rails = {
    ...
    targets = [{
      remotes = ["https://rubygems.org"];
      sha256 = "04h3pl85gxlbrjmgivz4l1r5b5xksswml4bs11zan8qybxhw2x9s";
      target = "x86_64-darwin";
      targetCPU = "x86_64";
      targetOS = "darwin";
      type = "gem";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "0ilqd8ccfn2xwf5gfq2nk2qdyfd11r8z0hjw6515rw8zm7i6nz20";
      target = "arm64-darwin";
      targetCPU = "arm64";
      targetOS = "darwin";
      type = "gem";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "1dxb05nsib11zz9l4mfslmfksyc4nj21fh9ig6vk6sh981gbmfpf";
      target = "aarch64-linux";
      targetCPU = "aarch64";
      targetOS = "linux";
      type = "gem";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "1f9jfyg2cx9xvaihhciqxb9gjpnjcjyh5f2lisw6ammy6aw5bb35";
      target = "arm-linux";
      targetCPU = "arm";
      targetOS = "linux";
      type = "gem";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "1jgkhvrfp80pvpyl10s6k9vcwvhgslnqvsjaf0rha4vlh9nk2s39";
      target = "x86_64-linux";
      targetCPU = "x86_64";
      targetOS = "linux";
      type = "gem";
